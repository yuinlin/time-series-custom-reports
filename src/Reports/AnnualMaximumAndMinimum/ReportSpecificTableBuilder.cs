...
namespace AnnualMaximumAndMinimumNamespace
{
    public class ReportSpecificTableBuilder
    {
        ...
        public static void AddReportSpecificTables(DataSet dataSet)
        {
            try
            {
                ...
                settingsTable.Rows[0]["ReportTitle"] = "Annual Maximum and Minimum";

                DataTable table = new DataTable("AnnualMaximumAndMinimumDataTable");
