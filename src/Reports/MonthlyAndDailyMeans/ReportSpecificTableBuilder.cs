...
namespace MonthlyAndDailyMeansNamespace
{
    public class ReportSpecificTableBuilder
    {
        ...
        public static void AddReportSpecificTables(DataSet dataSet)
        {
            try
            {
                ...
                settingsTable.Rows[0]["ReportTitle"] = "Monthly and Daily Means";

                DataTable table = new DataTable("MonthlyAndDailyMeansDataTable");
