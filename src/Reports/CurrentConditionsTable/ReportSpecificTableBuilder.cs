...
namespace CurrentConditionsTableNamespace
{
    public class ReportSpecificTableBuilder
    {
        ...
        public static void AddReportSpecificTables(DataSet dataSet)
        {
            try
            {
                ...
                settingsTable.Rows[0]["ReportTitle"] = "Current Conditions Table";

                DataTable table = new DataTable("CurrentConditionsTableDataTable");
