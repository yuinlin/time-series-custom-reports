...
namespace DailyAggregateByYearNamespace
{
    public class ReportSpecificTableBuilder
    {
        ...
        public static void AddReportSpecificTables(DataSet dataSet)
        {
            try
            {
                ...
                settingsTable.Rows[0]["ReportTitle"] = "Daily Aggregate by Year";

                DataTable table = new DataTable("DailyAggregateByYearDataTable");
