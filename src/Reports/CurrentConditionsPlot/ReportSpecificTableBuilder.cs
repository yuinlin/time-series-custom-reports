...
namespace CurrentConditionsPlotNamespace
{
    public class ReportSpecificTableBuilder
    {
        ...
        public static void AddReportSpecificTables(DataSet dataSet)
        {
            try
            {
                ...
                settingsTable.Rows[0]["ReportTitle"] = "Current Conditions Plot";

                DataTable table = new DataTable("CurrentConditionsPlotDataTable");
