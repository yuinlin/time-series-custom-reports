...
namespace FieldVisitReadingsInMultipleLocationsNamespace
{
    public class ReportSpecificTableBuilder
    {
        ...
        public static void AddReportSpecificTables(DataSet dataSet)
        {
            try
            {
                ...
                settingsTable.Rows[0]["ReportTitle"] = "Field Visit Readings in Multiple Locations";

                DataTable table = new DataTable("FieldVisitReadingsInMultipleLocationsDataTable");
