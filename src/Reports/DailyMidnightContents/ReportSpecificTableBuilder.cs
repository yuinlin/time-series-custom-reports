...
namespace DailyMidnightContentsNamespace
{
    public class ReportSpecificTablesBuilder
    {
        ...
        public static void AddReportSpecificTables(DataSet dataSet)
        {
            try
            {
                ...
                if (timeseriesType != "ProcessorDerived") throw (new Exception("Input is not a derived time-series. Input signal must be a daily selected value derived time-series."));
