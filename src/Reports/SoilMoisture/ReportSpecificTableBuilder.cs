...
namespace SoilMoistureNamespace
{
    public class ReportSpecificTablesBuilder
    {
        ...
        public static void AddReportSpecificTables(DataSet dataSet)
        {
            try
            {
                ...
                settingsTable.Rows[0]["ReportTitle"] = "Daily Soil Moisture Averages and Monthly Rainfall Totals";

                DataTable table = new DataTable("SoilMoistureDataTable");
